...
class TemporalConstraintTest {
    ...
    void Equals_서로_같은_경우(){
        //when
        TemporalConstraint tc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.DEEP_WORK);
        TemporalConstraint sameTc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.DEEP_WORK);
    ...
    void Equals_Duration_불일치(){
        //when
        TemporalConstraint tc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.DEEP_WORK);
        TemporalConstraint diffTc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(4), AllocateType.DEEP_WORK);
    ...
    void Equals_시각_불일치(){
        //when
        TemporalConstraint tc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.DEEP_WORK);
        TemporalConstraint diffTc = new TemporalConstraint(ZonedDateTime.now(clock).plusHours(3), Duration.ofHours(3), AllocateType.DEEP_WORK);
    ...
    void Equals_일정_타입_불일치(){
        //when
        TemporalConstraint tc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.DEEP_WORK);
        TemporalConstraint diffTc = new TemporalConstraint(ZonedDateTime.now(clock), Duration.ofHours(3), AllocateType.ADMIN_TASK);
