...
class DateTimeUtilsTest {
    ...
    void lastMondayStart() {
        ...
        ZonedDateTime zonedDateTime = dateTimeUtils.lastMondayStart(ZonedDateTime.of(LocalDateTime.of(2025, 11, 19, 10, 30, 0), ZoneId.of("Asia/Seoul")));
        ...
        Assertions.assertThat(zonedDateTime.getZone()).isEqualTo(ZoneId.of("Asia/Seoul"));
    }
}